...
file = open("C://Users\Coder_Aaron\PycharmProjects\MaFengWo\mafengwo.txt", 'a')
for i in range(min_page,max_page):
    try:
        url="http://www.mafengwo.cn/yj/10035/2-0-"+str(i)+".html"
        ...
        print(result)
        for item in result:
            file.write("http://www.mafengwo.cn"+item+'\n')
